define("lib/iscroll/iscroll", [], function(a, b, c) {
                        ...
                        if (this.options.snap === !0)
                            for (c = d.round(k / 2), e = d.round(l / 2); j > -this.scrollerWidth;) {
                                ...
                                for (g = this.options.snap, a = g.length, b = -1; a > h; h++)
                                    (0 === h || g[h].offsetLeft <= g[h - 1].offsetLeft) && (i = 0, b++), this.pages[i] || (this.pages[i] = []), j = d.max(-g[h].offsetLeft, this.maxScrollX), f = d.max(-g[h].offsetTop, this.maxScrollY), c = j - d.round(g[h].offsetWidth / 2), e = f - d.round(g[h].offsetHeight / 2), this.pages[i][b] = {
                                        x: j,
                                        y: f,
    ...
    ! function() {
        ...
        var b = {},
            ...
            e = {
                playerType: "",
                uniplayerUrl: "https://passport-log.youku.com/logsys/logstorage/append?project=uniplayer&log=",
                MPIECEURL: "https://passport-log.youku.com/logsys/logstorage/append?project=mpiece&log=",
                userCache: {
                    a1: "4",
                    a2: "1"
                },
        ...
        I.prototype = {
            ...
            selectH5VTag: function() {
                e.playerType = "h5";
                var a = "https://v.youku.com/player/getM3U8/vid/" + this._vid + "/type/mp4/ts/" + parseInt((new Date).getTime() / 1e3),
        ...
        k.mp4srcs = [], k.start = function(a, b, c, d) {
            ...
            var a, b = "https://v.youku.com/player/getPlayList/VideoIDS/" + this._vid,
        ...
        U.prototype = {
            ...
            getVideoSrc: function(a, c, d, f, g, h) {
                ...
                var l = c.segs[d][a].seconds,
                    a = c.segs[d][a].k;
                return ("" == a || -1 == a) && (a = c.key2 + c.key1), d = "", c.show && (d = c.show.show_paid ? "&ypremium=1" : "&ymovie=1"), c = "/player/getFlvPath/sid/" + e.userCache.sid + "_" + k + "/st/" + j + "/fileid/" + f + "?K=" + a + "&hd=" + i + "&myp=0&ts=" + l + "&ypp=0" + d, f = encodeURIComponent(D(E(F(b.mk.a4 + "poz" + e.userCache.a2, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), e.userCache.sid + "_" + f + "_" + e.userCache.token))), c = c + ("&ep=" + f) + "&ctype=12&ev=1&token=" + e.userCache.token, c += "&oip=" + b.v.data[0].ip, "https://k.youku.com" + (c + ((g ? "/password/" + g : "") + (h ? h : "")))
            }
        };
        var R = function(a) {
        ...
        $.prototype = {
            ...
            pay: function() {
                this.player.video.pause(), -1 !== this._payBtn.innerHTML.indexOf("会员") ? window.open("https://cps.youku.com/redirect.html?id=000002b0", "", "", !1) : window.open("https://cps.youku.com/redirect.html?id=000002b1&url=" + escape("https://pay.youku.com/buy/redirect.html?pstype=1&psid=" + this._showid), "", "", !1), this.player._reporter.sendUserActionReport("xbuy", "c")
            },
            hide: function() {
        ...
        ca.prototype = {
            ...
            onTouchEnd: function(a) {
                if (this.dispatch({
                        type: "progressend"
                    }), this.isTouching = !1, 1 < a.changedTouches.length)
                    return !1;
                var c = {
        ...
        ga.prototype = {
            ...
            request: function(a) {
                ...
                c.__callback = "relatedpanel.parseResponse", c = "https://v.youku.com/player/getRelatedPlayList?" + n(c), w(c)
            },
            ...
            buildPanel: function(a) {
                ...
                var d = [];
                d.push('<ul class="x-item" data-i="x"><li class="x-item-img"><img src="https://player.youku.com/h5player/img/replay.png"></li></ul>');
                for (var e = Math.floor((this._panel.offsetWidth - 60 + 16) / 166) * Math.floor((this._panel.offsetHeight - 120 + 12) / 97), e = (e > c ? c : e) - 1, e = 0 > e ? 0 : e, c = 0; e > c; c++) {
                    var f = a[c].logo,
                        ...
                        h = a[c].link;
                    "myoukucom" == b.initConfig.client_id && (h = "https://m.youku.com/smartphone/detail?vid=" + a[c].videoid), d.push('<ul class="x-item" data-i=' + c + '><li class="x-item-img"><img src=' + f + '></li><li class="x-item-info"><div class="x-item-title">' + g + '</div><div class="x-item-bg"></div></li><li class="x-item-url"><a href=' + h + ' target="_blank"></a></li><li class="x-item-loading"><div class="x-play-loading"></div></li></ul>')
                }
            ...
            onLoadImgError: function(a) {
                debug.log("img error"), a = a.target, b.addClass(a.parentNode.parentNode, "x-no-pic"), a.src = "https://player.youku.com/h5player/img/no_pic.png"
            },
            replay: function(a) {
            ...
            init: function(a) {
                ...
                if (null != c && 0 != c.length) {
                    for (var d = ["<ul class=x-showlist-bullet>", "", "</ul>"], e = [], f = 0; f < c.length; f++) {
                        var g = c[f],
                            h = "https://v.youku.com/v_show/id_" + g.vidEncoded + ".html";
        ...
        K.prototype = {
            sendRecommendLog: function(a) {
                ...
                c.sid = b.videoInfo._sid, a = {
                    ...
                    alginfo: a.alginfo,
                    sid: 0
                }, c.show && (a.sid = c.show.showid), a.xts = parseInt(1e4 * Math.random()), e.Log("https://e.stat.youku.com/recommond/log?" + n(a))
            },
            tsInit: function() {
                this.tsSn = null
            },
            ...
            sendVVLog: function(a) {
                ...
                e.Log("https://v.l.youku.com/ykvvlog?" + n(d))
            },
            ...
            addPlayerDurationReport: function(a) {
                ...
                if (null != c && null != c._playListData) {
                    ...
                    f.sid = c._sid, f.videoOwnerId = b.v.data[0].userid, f.viewUserId = b.v.user.id, f.videoid = b.v.data[0].videoid, f.ct = b.v.data[0].ct, f.cs = b.v.data[0].cs, f.number = a, f.rnd = ((new Date).getTime() - c.abstarttime) / 1e3, null != c._playListData.show ? (f.showid_v2 = null == c._playListData.show ? "" : c._playListData.show.showid, f.showid_v3 = null == c._playListData.show ? "" : c._playListData.show.showid_encode, f.show_videotype = c._playListData.show.show_videotype, f.stg = c._playListData.show.stage, f.Tid = c._playListData.show.theaterid, f.Copyright = c._playListData.show.copyright) : (f.showid_v2 = "", f.Tid = 0, f.Copyright = ""), f.hd = 0, f.ikuflag = "m", f.hd = {
                        ...
                        hd2: 2,
                        hd3: 3
                    }[b.defaultVideoType], f.winType = b.WIN_TYPE, f.mtype = P(), f.totalsec = c.totalTime, f.fullflag = this.player.controls.fullscreenPanel.fullFlag(), f.playComplete = 0, 61 == a && (f.playComplete = 1), 59 == a && (f.referUrl = (b.initConfig.vvlogconfig || "").rurl, f.url = encodeURIComponent(window.location.href), f.starttime = 0), f.currentPlayTime = parseInt(this.player.currentTime || 0), f.continuationPlay = 0, f.pid = b.initConfig.client_id, f.timestamp = (new Date).getTime(), f.ctype = "12", f.ev = "1", f.tk = e.userCache.token, f.oip = b.v.data[0].ip, e.Log("https://stat.youku.com/player/addPlayerDurationReport?" + n(f))
                }
            },
            addPlayerStaticReport: function() {
                ...
                for (var c = a.t, d = !1, f = ""; !d;) {
                    for (var f = "", g = 0; 20 > g; g++)
                        var h = Math.floor(61 * Math.random()),
                ...
                a.h = f, a.totalseg = b.pieceLength(), a = n(a), e.Log("https://stat.youku.com/player/addPlayerStaticReport?" + a)
            },
            sendUserActionReport: function(a, c, d) {
                ...
                if (c.x = D(n(f)), g = n(c), "xre" == a)
                    this.checkPlayerResize("https://e.stat.ykimg.com/red/ytes.php?", g);
                else {
                    if ("xenfs" == a || "xexfs" == a) {
                        this._giveupReTag = !0;
                        var h = this;
                    ...
                    e.Log("https://p-log.ykimg.com/event?" + g)
                }
            ...
            sendCustomLoadedTime: function(a) {
                a = {
                    ...
                    cost: a,
                    ver: VER.replace(/[-:]/g, "")
                }, 0 == a.mobile && (a.ua = escape(navigator.userAgent.replace(/[\/\+\*@\(\)\,]/g, ""))), e.Log("https://passport-log.youku.com/logsys/logstorage/append?project=xplayerloadtime&log=" + p(a))
            },
            sendUepReport: function(a, c, d) {
                ...
                }, e.Log("https://v.l.youku.com/uep?" + n(a)))
            },
                ...
                if (!this._hasComScore) {
                    for (var c = document.getElementsByTagName("script"), d = 0; d < c.length; d++)
                        if (-1 !== c[d].src.indexOf("scorecardresearch.com/beacon.js")) {
                            this._hasComScore = !0;
                            break
                        }!0 !== this._hasComScore && (c = document.createElement("script"), d = document.getElementsByTagName("script")[0], c.async = !0, c.src = ("https:" == document.location.protocol ? "https://sb" : "https://b") + ".scorecardresearch.com/beacon.js", d.parentNode.insertBefore(c, d)), this._hasComScore = !0
                }
            ...
            sendPayReport: function() {
                ...
                e.Log("https://passport-log.youku.com/logsys/logstorage/append?project=unipay&log=" + p(a))
            },
        ...
        ja.prototype = {
            ...
            buildAdRS: function() {
                for (var a = "https://pl.youku.com/playlist/m3u8?", c = {}, d = {}, f = this._adinfo.VAL, g = 0; g < f.length; g++) {
                    var h = f[g];
                        ...
                        if (null != d.VID && null != d.VQT) {
                            ...
                            if (b += d.AL, a.CU.push({
                                ...
                                for (e = 0; e < this._vt2nodes.length; e++)
                                    d = this._vt2nodes[e].VC, f = this._vt2nodes[e].pos_, -1 == f && a.VTVC.push({
                                        U: d,
                                        T: 0
                                    }), f == c && a.VTVC.push({
                                        U: d,
        ...
        L.prototype = {
            ...
            FRONT_REQUEST_BASE: "https://mf.atm.youku.com/mf?",
            BACK_REQUEST_BASE: "https://mb.atm.youku.com/mb?",
            PAUSE_REQUEST_BASE: "https://mp.atm.youku.com/mp?",
            INSERT_REQUEST_BASE: "https://valo.atm.youku.com/valo?",
            OVERLAY_REQUEST_BASE: "https://valc.atm.youku.com/valc?",
            FRONT_AD: "frontAD",
            BACK_AD: "backAD",
            INSERT_AD: "insertAD",
            PAUSE_AD: "pauseAD",
        ...
        M.prototype = {
            ...
            bindEvent: function() {
                ...
                this.fSkipAd = function() {
                    a.adplayer.video.pause(), window.open("https://cps.youku.com/redirect.html?id=000002bf", "", "", !1)
            ...
            buildTestData: function() {
                return {
                    VAL: [{
                        ...
                        VQT: "flv",
                        SUS: [{
                            U: "https://mytestdata.com1"
                        }, {
                            U: "https://mytestdata.com2"
                        }],
                        SU: [],
                        SUE: [],
                        CU: "https://www.baidu.com",
                        CUM: [{
                            U: "https://cum"
                        }],
                        RS: "https://fasdfa"
            ...
            buildPauseData: function() {
                return adinfo = {
                    P: 10,
                    VAL: [{
                        RS: "https://static.atm.youku.com/Youku2013/201307/0715/27896/600-430.jpg",
                        RST: "img",
                        AT: 73,
                        SU: [],
                        SUS: [{
                            U: "https://mf.atm.youku.com/mshow?v=137006183&at=73&ct=d&cs=1003&ca=135159&ie=150597&uid=1234567&ck=137689524489061H&al=0&bl=1&s=&td=&st=1&vl=1200.0&ap=4&sid=1&cr=0&tvb=0&pr=100&oidtype=27896%7C1&tpa=null&rid=&os=1&dt=1&aw=a&avs="
                        }],
                        SUE: [],
                        CU: "https://vid.atm.youku.com/mclick?v=137006183&at=73&ct=d&cs=1003&ca=135159&ie=150597&uid=1234567&ck=137689524489061H&al=0&bl=1&s=&td=&st=1&vl=1200.0&ap=4&sid=1&cr=0&tvb=0&pr=100&oidtype=27896%7C1&tpa=null&rid=&os=1&dt=1&aw=a&avs=&u=https://static.youku.com/pub/youku/fragment/panel_phone.html&md5=f2450cd80597324b57d986147dc1b3a9",
                        W: 400,
                        H: 300,
                        CF: "1"
                    }]
        ...
        }, x("https://player.youku.com/h5player/play.css?ver=" + VER.replace(/[-:]/g, ""), "css");
        var ma = function(a, c) {
            this.setting = {
                debug: !1,
        ...
        b.WIN_TYPE = 30, b.defaultVideoType = "mp4", b.resizeTag = !0, b.extend = function(a, b) {
            ...
            var c = "https://v.youku.com/player/getM3U8/vid/" + a + "/type/" + b + "/ts/" + parseInt((new Date).getTime() / 1e3);
            ...
            return d.ep = f, d.sid = e.userCache.sid, d.token = e.userCache.token, d.ctype = "12", d.ev = "1", d.oip = b.v.data[0].ip, "https://pl.youku.com/playlist/m3u8?" + n(d)
    ...
    c.exports = d,
        function(a) {
            ...
            a.active = 0, a.ajaxJSONP = function(b, c) {
                ...
                if (e && e.promise(v), c.crossDomain || t("X-Requested-With", "XMLhttpsRequest"), t("Accept", r || "*/*"), (r = c.mimeType || r) && (r.indexOf(",") > -1 && (r = r.split(",", 2)[0]), v.overrideMimeType && v.overrideMimeType(r)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && t("Content-Type", c.contentType || "application/x-www-form-urlencoded"), c.headers)
                    for (q in c.headers)
                        t(q, c.headers[q]);
...
}), define("modules/app/main", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "system/util/objectUtil", "units/globalAudio", "lib/zepto/coffee"], function(require, exports, module) {
            ...
            e.each(function(a, b) {
                console.log("facade init"), $page = d(b), $page.find(".u_sper").on("swipeLeft", function() {
                    ...
                    d(this).animate({
                        ...
                        d(this).find("li").first().appendTo(this), d(this).css({
                            left: 0
                        }), console.log("left")
                    }, 600)
                }).on("swipeRight", function() {
                    var a = d(this).find("li").last().width();
                    d(this).find("li").last().prependTo(this), d(this).css({
                        left: -a + "px"
                    }), d(this).animate({
                        left: 0
                    }, function() {}, 600), console.log("right")
...
}), define("modules/form/main", ["lib/zepto/zepto", "units/maskLayer", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/globalAudio", "lib/iscroll/iscroll"], function(a, b, c) {
    var d = a("lib/zepto/zepto"),
        d = a("units/maskLayer"),
                ...
                if (g.length) {
                    ...
                    l.on("show", function() {
                        ...
                        if (e.length > 0 && d.trim(e.val()).length > 0) {
                            ...
                            if (!d.trim(e.val()).match(j))
                                return c(e, "电话号码输入不正确！")
                        }
                        if (i.length && 0 == d.trim(i.val()).length)
                            return c(i, "请输入邮箱！");
                        if (i.length > 0 && d.trim(i.val()).length > 0) {
                            var j = /(^[a-z\d]+(\.[a-z\d]+)*@([\da-z](-[\da-z])?)+(\.{1,2}[a-z]+)+$)/i;
                            if (!d.trim(i.val()).match(j))
                                return c(i, "邮箱格式不正确！")
                        }
                    ...
                    function() {
                        ...
                        b.is(".m-animationCloudBg") ? (b.animationCloudBg(), c = "appBg1") : b.is(".m-meteorShower") && (b.meteorShower({
                            ...
                            var b = parseInt(a.data("app-id")),
                                d = [3468];
                            d.indexOf(b) >= 0 ? a.css("background-image", "url(https://www.cnwyy.com.cn/lightapp/style/img/app_" + b + ".jpg)") : a.addClass(c)
                        })
                    }(), $page.on("active", function() {
    ...
    ! function() {
        var a = function(a, b) {
            ...
            for (var c, e, f, g, h, i = "", j = 0; j < this.settings.starCount; j++)
                c = (640 * Math.random()).toFixed(2), e = (600 * Math.random()).toFixed(2), g = Math.random().toFixed(2), h = (1 + 4 * Math.random()).toFixed(), f = Math.round(1 + 3 * Math.random()), i += '<i class="star style' + f + '" style="left:' + c + "px; top:" + e + "px; -webkit-animation-delay:" + g + "s; -webkit-animation: star " + h + 's linear infinite;"></i>';
            for (var j = 0; j < this.settings.meteorCount; j++)
                c = (800 * Math.random() - 280).toFixed(2), e = (100 * Math.random() - 80).toFixed(2), g = (.5 + 2.5 * Math.random()).toFixed(), h = (1.2 + 2.8 * Math.random()).toFixed(), f = Math.round(1 + 3 * Math.random()), i += '<i class="meteor style' + f + '" style="left:' + c + "px; top:" + e + "px; -webkit-animation-delay:" + g + "s; -webkit-animation: meteor " + h + 's linear infinite;"></i>';
...
}), define("modules/link/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/maskLayer", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/globalAudio"], function(a, b, c) {
    var d = a("lib/zepto/zepto"),
...
}), define("modules/map/main", ["lib/zepto/zepto", "units/yunlaiMap", "lib/zepto/selector", "lib/zepto/touch", "https://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737", "modules/app/main", "units/globalAudio"], function(require, exports, module) {
    var $ = require("lib/zepto/zepto"),
            ...
            $mapPages.each(function(i, item) {
                ...
                $page.on("active", function() {
                    ...
                    distributedPointsInitFlag && (distributedPointsInitFlag = !1, a.find(".m-distributedPoints li").each(function(a, b) {
                        b.style.left = b.offsetLeft  - 11 + "px",b.style.top = (b.offsetTop + 6) - 55 + "px", $(b).find("a").css("left", b.offsetWidth / 2 - 31.5)
                    }))
                }).on("current", function() {
...
}), define("modules/video/main", ["lib/zepto/zepto", "lib/zepto/touch", "units/maskLayer", "lib/zepto/selector", "lib/zepto/data", "./youkuVideo", "lib/youku/jsapi", "modules/app/main", "units/globalAudio", "lib/zepto/coffee", "system/util/objectUtil"], function(a, b, c) {
    var d = a("lib/zepto/zepto"),
        d = a("lib/zepto/touch"),
        d = a("units/maskLayer"),
        d = a("./youkuVideo"),
        ...
        var a = 0,
            b = function(b, c) {
                ...
                this.settings = d.extend({
                    ...
                    url: h && h.indexOf("youku") >= 0 ? h : "https://v.youku.com/v_show/id_XNzAyNDcyMzAw.html",
...
}), define("page/main", ["modules/app/main", "lib/zepto/zepto", "lib/zepto/selector", "units/globalAudio", "modules/index/main", "modules/index/animationCloudBg", "modules/index/meteorShower", "modules/teletext/main", "modules/teletext/cascadingTeletext", "modules/link/main", "units/maskLayer", "modules/video/main", "modules/facade/main", "lib/zepto/touch", "modules/video/youkuVideo", "modules/map/main", "units/yunlaiMap", "modules/form/main", "lib/iscroll/iscroll"], function(a) {
    window.app = a("modules/app/main"), window.app.showPage(".page-index"), a("modules/index/main").init(), a("modules/teletext/main").init(), a("modules/link/main").init(), a("modules/video/main").init(), a("modules/facade/main").init(), a("modules/map/main").init(), a("modules/form/main").init(), console.log("\n运行成功！"), $(".app-footer").after($("input[data-weixin-callback]"))
    ...
    var d = a("lib/zepto/zepto"),
        ...
        f = function(a) {
            ...
            this._$globalAudio.append(this._$tip), this._$globalAudio.coffee({
                steams: ['<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>', '<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>', '<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>', '<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>', '<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>', '<img src="https://www.cnwyy.com.cn/lightapp/style/img/musicalNotes.png"/>'],
                steamHeight: 100,
                steamWidth: 50
        ...
        function(a) {
            a.fn.ylmap = function(b) {
                ...
                return this.addClass("ylmap").each(function() {
                    function b() {
                        var b = document.createElement("script");
                        b.src = "https://api.map.baidu.com/api?v=1.4&callback=mapInit", document.head.appendChild(b);
...
}), define("units/yunlaiMap", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "https://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737"], function(a, b, c) {
    var d = a("lib/zepto/zepto"),
        d = a("lib/zepto/selector"),
        d = a("lib/zepto/touch");
    window.BMap_loadScriptTime = (new Date).getTime(), a("https://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737"),
        function() {
            var a = 0,
                b = function(b, c) {
                    var e = this;
